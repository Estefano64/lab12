    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <form action="{{ route('categorias.update', $categoria) }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="nombre" value="{{ $categoria->nombre }}" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400" required>
            </div>
